            ...
            res.status(200).json({
                ...
                events: docs.map((doc) => {
                    return {
                        ...
                        meta: {
                            type: "GET", 
                            url: "https://nameless-harbor-15056.herokuapp.com/events/" + doc._id
                        }
                    }
                })
            })
            ...
            res.status(200).json({
                ...
                event: {
                    ...
                    meta: {
                        ...
                        url: "https://nameless-harbor-15056.herokuapp.com/events"
                    }
                }
            })
        })
    ...
    Event.update({ _id: id }, { $set: updateOps }).exec()
        .then((response) => {
            ...
            res.status(200).json({
                ...
                meta: {
                    type: "GET", 
                    url: "https://nameless-harbor-15056.herokuapp.com/events/" + id
                }
            })
        })
        .catch((error) => { 
